...
pub fn vec3_annotation(datatypes: &Vec<Datatype>) -> Datatype {
    ...
    let z_component = coerce_datatype_to_f64(datatypes.get(2), y_component);

    Datatype::Variant(Variant::Vector3(Vector3::new(
        x_component as f32,
        y_component as f32,
        z_component as f32,
    )))
...
pub fn vec3i16_annotation(datatypes: &Vec<Datatype>) -> Datatype {
    ...
    Datatype::Variant(Variant::Vector3int16(Vector3int16::new(
        x_component as i16,
        y_component as i16,
        z_component as i16,
    )))
